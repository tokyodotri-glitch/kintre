...
- **記録** — 7部位（胸 / 背 / 肩 / 腕 / 脚 / 体幹 / **自重** / カスタム）から種目を選択。フリーウェイトと自重トレ両対応
- **自重対応** — 「自重」「時間（秒）」マーカーで適切なUI（+kg / 秒数入力）に自動切替。プランクなど時間ベースの種目もOK
- **履歴** — セッション別に展開可能。総ボリューム・部位コード・PR バッジ表示
- **推移** — 種目別の折れ線グラフ。フリーウェイトは最大重量 / 総ボリューム / 推定1RM、自重は最大レップ / 合計レップ
- **実績** — 21種類のバッジ（マイルストーン / ストリーク / ボリューム / PR / 自重 / バラエティ / ライフスタイル）
